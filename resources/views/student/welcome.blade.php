@extends('...layouts.layout')
    ...
    <main>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-6 col-lg-7 col-md-8">
                                <div class="hero__caption">
                                    <span data-animation="fadeInLeft" data-delay=".2s">Une Bibliotheque au service des étudiants</span>
                                    <h1 data-animation="fadeInLeft" data-delay=".4s">Reservez le livre que vous voulez et passez le recupérer</h1>
                                    <!-- Hero-btn -->
                                    <div class="hero__btn">
                                        <a href="/books" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s">Livres disponibles</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-5">
                                <div class="hero-man d-none d-lg-block f-right" data-animation="jello" data-delay=".4s">
                                    <img src="/img/hero/heroman.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                ...
                                <a href="#" class="read-more1">Parcourir ></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
        ...
        <!-- Categories Area End -->
        <!--? Count Down Start -->
        <div class="count-down-area pt-90 pb-60 section-bg" data-background="/img/gallery/section_bg01.png">
            <div class="container">
                <div class="row justify-content-sm-center">
                    <div class="cl-xl-7 col-lg-8 col-md-10">
                        <!-- Section Tittle -->
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="single-counter text-center">
                                        ...
                                        <span class="counter color-blue">60</span>
                                        <p class="color-blue">+ Enseignants</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <!-- Counter Up -->
                                    <div class="single-counter text-center">
                                        ...
                                        <p class="color-green">+ Partenaires</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <!-- Counter Up -->
        ...
        <!-- Popular Course End -->
        <!--? Team Ara Start -->
        <div class="team-area pt-160 pb-160 section-bg" data-background="/img/gallery/section_bg02.png">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="cl-xl-7 col-lg-8 col-md-10">
                        <!-- Section Tittle -->
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption mb-50">
                            ...
                            <p>Il est nécessaire de respecter les conditions suivantes</p>
                            <ul>
                                <li><span class="flaticon-business"></span>Recupérer livres après maximum 3 jours après reservation</li>
                                <li><span class="flaticon-communications-1"></span>Reserver maximun 3 livres</li>
                                <li><span class="flaticon-graduated"></span>7 jours pour livrer le livre emprunter</li>
                            </ul>
                            <a href="about.html" class="btn">Plus de détails</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <!-- about-img -->
